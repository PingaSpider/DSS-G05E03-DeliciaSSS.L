...
<body>
    <div class="container">
        ...
        <div class="product-card">
            ...
            <div class="product-data">
                <h3>Características de la Bebida</h3>
                <div class="data-row">
                    <span class="data-label">Tamaño:</span>
                    <span class="data-value">{{ $bebida->tamanyo }}</span>
                </div>
                <div class="data-row">
                    <span class="data-label">Tipo:</span>
                    <span class="data-value">
                        <span class="tipo-badge tipo-{{ $bebida->tipoBebida }}">
            ...
            <div class="action-buttons">
                <a href="{{ route('bebidas.edit', $producto->cod) }}" class="btn btn-primary">Editar</a>
                ...
                <form action="{{ route('bebidas.destroy', $producto->cod) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta bebida?')">Eliminar</button>
                </form>
            </div>
        </div>
    </div>
